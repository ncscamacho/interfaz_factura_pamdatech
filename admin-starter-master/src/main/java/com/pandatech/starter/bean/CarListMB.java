...
import com.pandatech.infra.model.Filter;
import com.pandatech.model.Car;
import com.pandatech.service.CarService;
...
import static com.pandatech.util.Utils.addDetailMessage;
    ...
    public void initDataModel() {
        cars = new LazyDataModel<Car>() {
            ...
            public List<Car> load(int first, int pageSize,
                ...
                com.pandatech.infra.model.SortOrder order = null;
                if (sortOrder != null) {
                    order = sortOrder.equals(SortOrder.ASCENDING) ? com.pandatech.infra.model.SortOrder.ASCENDING
                            : sortOrder.equals(SortOrder.DESCENDING) ? com.pandatech.infra.model.SortOrder.DESCENDING
                            : com.pandatech.infra.model.SortOrder.UNSORTED;
                }
